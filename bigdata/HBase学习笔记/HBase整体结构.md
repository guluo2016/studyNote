转载自[扎心了老铁的博客]：[HBase学习之路 （七）HBase 原理](https://www.cnblogs.com/qingyunzong/p/8692430.html)
...
![img](../../image/bigdata/hbase/HBasea架构图.png)
...
#### 整体的物理结构
 ...
 ![img](../../image/bigdata/hbase/物理存储架构.png)
...
![img](../../image/bigdata/hbase/HFile文件结构.png)
